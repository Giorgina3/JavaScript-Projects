...
function placeXOrO(squareNumber)  {
    //This condition ensures a squares hasn't be selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        checkWinConditions();
        //This condition is for changing teh active player.
        if (activePlayer === 'X') {
        ...
        function computersTurn() {
            ...
            while(!succes) {
                //A random number between 0 and 8 is elected 
...
function checkWinConditions() {
    ...
    // X 1, 4, 7 condition.
     ...
     else if (selectedSqyares.length >= 9) {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method drws everything we laid out above.
        c.stroke();
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y +=10; }
            //This condition cancels our animation loop if reacyh the end points.
            if(x >=x2 && y >=y2) { cancelAnimationFrame(animationLoop); }
       
        }
        //This condition is similat to the one abose.
    ...
    //The, clears canvas, resets game, and allows clicking again.
...
function resetGame() {
    ...
    //This resets our array so it is empty an we can start over.
    selectSquares = [];
}